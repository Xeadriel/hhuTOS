...
use crate::{devices::cga::CGA, kernel::threads::scheduler::{get_scheduler, unlock_scheduler}};

pub struct CgaLock {
    cga: Mutex<CGA>,           // actual locking primitive
